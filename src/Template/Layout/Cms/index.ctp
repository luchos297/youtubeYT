...
<body class="off-canvas">
    <div id="container">
        <header id="header">
            <!--logo start-->
            <div class="brand">
                <a href="index.html" class="logo"><span>Portales</span>.</a>
            </div>
            <!--logo end-->
            ...
            <div class="user-nav">
                <ul>
                    <li class="dropdown messages">
                        ...
                        <ul class="dropdown-menu alert animated fadeInDown">
                            ...
                            <li>
                                <a href="#">
                                    <div class="profile-photo">
                                        <?= $this->Html->image('/img/template-cms/avatar1.gif', ['alt' => '','class'=>'img-circle']); ?>
                                    </div>
                                    <div class="message-info">
                            ...
                            <li>
                                <a href="#">
                                    <div class="profile-photo">
                                        <?= $this->Html->image('/img/template-cms/avatar2.gif', ['alt' => '','class'=>'img-circle']); ?>
                                    </div>
                                    <div class="message-info">
                            ...
                            <li>
                                <a href="#">
                                    <div class="profile-photo">
                                        <?= $this->Html->image('/img/template-cms/avatar3.gif', ['alt' => '','class'=>'img-circle']); ?>
                                    </div>
                                    <div class="message-info">
                            ...
                            <li>
                                <a href="#">
                                    <div class="profile-photo">
                                        <?= $this->Html->image('/img/template-cms/avatar4.gif', ['alt' => '','class'=>'img-circle']); ?>
                                    </div>
                                    <div class="message-info">
                    ...
                    <li class="profile-photo">
                        <?= $this->Html->image('/img/template-cms/avatar.png', ['alt' => '','class'=>'img-circle']); ?>
                    </li>
                        ...
                        <div class="list-contacts">
                            ...
                            <a href="javascript:void(0)" class="list-item">
                                <div class="list-item-image">
                                    ...
                                    <?= $this->Html->image('/img/template-cms/avatar5.gif', ['alt' => '','class'=>'img-circle']); ?>
                                </div>
                                <div class="list-item-content">
                                    <h4>Gerald Carr</h4>
                                    <p>Seattle, WA</p>
                            ...
                            <a href="javascript:void(0)" class="list-item">
                                <div class="list-item-image">
                                    ...
                                    <?= $this->Html->image('/img/template-cms/avatar6.gif', ['alt' => '','class'=>'img-circle']); ?>
                                </div>
                                <div class="list-item-content">
