...
<div class="wrapper">
    ...
    <div class="main-content has-double-sidebar">
                    ...
                    <?php if(count($noticias_seccion) > 0): ?>
                        ...
                        <?php if($noticia->has('imagenes') && !empty($noticia->imagenes)): ?>
                            <div class="item-header">
                                ...
                                <a href="<?= $this->Url->build(['controller' =>'noticias','action' =>'articulo', $noticia->id]); ?>" class="image-hover" data-path-hover="">
                        ...
                        <?php else: ?>
                            <a href="#<?= $noticia->portal->codigo ?>">
                                <i class="seccion-nota seccion-no-absolute seccion-background"><?= $noticia->categoria->nombre ?></i>
                        ...
                        <div class="item-content">
                            <h3><a href="<?= $this->Url->build(['controller' =>'noticias','action' =>'articulo', $noticia->id]); ?>"><?= $noticia->titulo ?></a></h3>
        ...
        <div class="small-sidebar">
                    ...
                    <div class="item no-image">
                        <?php foreach(array_reverse($noticias_seccion) as $noticia):?>
                            <div class="item-content">
                                ...
                                <h4><a href="<?= $this->Url->build(['controller' =>'noticias','action' =>'articulo', $noticia->id]); ?>"><?= $noticia->titulo ?></a></h4>
                                <p><?= $noticia->descripcion ?></p>
                            </div>
                        <?php endforeach; ?>
                    </div>
            ...
            <!--<div class="widget">
                <div class="banner">
                    <?= $this->element('Front/banners/banner-160x600') ?>
                </div>
            </div>-->
            <div class="widget">
                <div class="banner">
