...
class BannersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'image_path' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        'view_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'creado' => '2016-02-04 15:06:16',
            'modificado' => '2016-02-04 15:06:16'
        ],
    ];
}
